            ...
            if use_cache:
                if hidden_states.shape[1] != 1:
                    if layer_idx<FASTV_k:
                        ...
                        top_attention_rank_index = last_layer_attention_avg_last_tok_image.topk(round(FASTV_image_token_length*(1.0-FASTV_r))).indices + FASTV_image_token_start_index
                        # keep index
                        ...
                        None, hidden_states, cache_position, 0
                    )
                else:
                    pruned_attention_mask = causal_mask
