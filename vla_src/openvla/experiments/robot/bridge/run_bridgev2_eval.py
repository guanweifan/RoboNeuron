...
# Append current directory so that interpreter can find vla_src.openvla.experiments.robot
sys.path.append(".")
from vla_src.openvla.experiments.robot.bridge.bridgev2_utils import (
    get_next_task_label,
...
from vla_src.openvla.experiments.robot.openvla_utils import get_processor
from vla_src.openvla.experiments.robot.robot_utils import (
    get_action,
