...
from vla_src.openvla.prismatic.conf import ModelConfig
from vla_src.openvla.prismatic.models.materialize import get_llm_backbone_and_tokenizer, get_vision_backbone_and_transform
from vla_src.openvla.prismatic.models.registry import GLOBAL_REGISTRY, MODEL_REGISTRY
from vla_src.openvla.prismatic.models.vlas import OpenVLA
from vla_src.openvla.prismatic.models.vlms import PrismaticVLM
from vla_src.openvla.prismatic.overwatch import initialize_overwatch
from vla_src.openvla.prismatic.vla.action_tokenizer import ActionTokenizer
...
def get_model_description(model_id_or_name: str) -> str:
    if model_id_or_name not in GLOBAL_REGISTRY:
        raise ValueError(f"Couldn't find `{model_id_or_name = }; check `vla_src.openvla.prismatic.available_model_names()`")
...
def load(
    ...
    if os.path.isdir(model_id_or_path):
        ...
        if model_id_or_path not in GLOBAL_REGISTRY:
            raise ValueError(f"Couldn't find `{model_id_or_path = }; check `vla_src.openvla.prismatic.available_model_names()`")
