...
from vla_src.openvla_oft.prismatic.extern.hf.configuration_prismatic import PrismaticConfig
from vla_src.openvla_oft.prismatic.extern.hf.modeling_prismatic import PrismaticForConditionalGeneration
