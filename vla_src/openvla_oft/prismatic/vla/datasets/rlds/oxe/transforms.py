...
from vla_src.openvla_oft.prismatic.vla.datasets.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
...
def franka_kitchen_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "franka_kitchen": franka_kitchen_transform,
}
