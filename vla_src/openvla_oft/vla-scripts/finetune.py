...
from vla_src.openvla_oft.prismatic.extern.hf.configuration_prismatic import OpenVLAConfig
from vla_src.openvla_oft.prismatic.extern.hf.modeling_prismatic import OpenVLAForActionPrediction
from vla_src.openvla_oft.prismatic.extern.hf.processing_prismatic import PrismaticImageProcessor, PrismaticProcessor
from vla_src.openvla_oft.prismatic.models.action_heads import DiffusionActionHead, L1RegressionActionHead
from vla_src.openvla_oft.prismatic.models.backbones.llm.prompting import PurePromptBuilder
from vla_src.openvla_oft.prismatic.models.film_vit_wrapper import FiLMedPrismaticVisionBackbone
from vla_src.openvla_oft.prismatic.models.projectors import (
    NoisyActionProjector,
    ProprioProjector,
)
from vla_src.openvla_oft.prismatic.training.train_utils import (
    compute_actions_l1_loss,
    compute_token_accuracy,
    get_current_action_mask,
    get_next_actions_mask,
)
from vla_src.openvla_oft.prismatic.util.data_utils import PaddedCollatorForActionPrediction
from vla_src.openvla_oft.prismatic.vla.action_tokenizer import ActionTokenizer
from vla_src.openvla_oft.prismatic.vla.constants import (
    ACTION_DIM,
    ACTION_PROPRIO_NORMALIZATION_TYPE,
    NUM_ACTIONS_CHUNK,
    PROPRIO_DIM,
)
from vla_src.openvla_oft.prismatic.vla.datasets import RLDSBatchTransform, RLDSDataset
from vla_src.openvla_oft.prismatic.vla.datasets.rlds.utils.data_utils import save_dataset_statistics
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    #
    # ---
    # from vla_src.openvla_oft.prismatic.vla.datasets import DummyDataset
    #
