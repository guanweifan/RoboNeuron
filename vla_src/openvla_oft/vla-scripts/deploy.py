...
from vla_src.openvla_oft.experiments.robot.robot_utils import (
    get_image_resize_size,
)
from vla_src.openvla_oft.prismatic.vla.constants import ACTION_DIM, ACTION_TOKEN_BEGIN_IDX, IGNORE_INDEX, NUM_ACTIONS_CHUNK, PROPRIO_DIM, STOP_INDEX
...
class DeployConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "/mnt/d/openvla/模型/openvla-oft-250810/openvla-7b+franka_kitchen+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--node4--100000_chkpt"    # Pretrained checkpoint path
    ...
    unnorm_key: Union[str, Path] = "franka_kitchen"                # Action un-normalization key
